...
import unreadMsgTag from "../../../public/images/Group 52.png";
...
const Aside = () => {
	return (
		<aside className="w-full max-w-[400px] h-screen flex justify-between pr-[5px]">
			<div className="h-full">
				<Image className="h-[94%] my-12" src={verticalStroke} alt="" />
			</div>
			<div className="flex flex-col gap-[40px] pr-[5px] pb-[45px]">
				<div className="w-full flex items-center justify-around gap-[24px] p-[42px] pb-0">
				...
				<div className="flex flex-col gap-[28px] overflow-y-auto custom-scrollbar px-[28px]  ">
